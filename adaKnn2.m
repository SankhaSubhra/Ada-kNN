function [ p, accuracy, gmeans ] = adaKnn2( trainS,label, testS, labelT, k_max )

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Implementation of Ada-kNN2 for regular classification problem.
